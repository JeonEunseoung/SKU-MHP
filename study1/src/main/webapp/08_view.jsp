...
<body>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="04_logoutPro.jsp">로그아웃</a></li>
					</ul>
				</li>
			</ul>
			<%
	...
	<div class="container">
		<div class="row">
			...
			<a href="07_writeform.jsp" class="btn btn-primary">목록</a>
			<%
				if (userID != null && userID.equals(bbs.getID())) {
			%>
					<a href="08_update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>
					<a onclick="return confirm('정말 삭제하시겠습니까?')" 
        href="08_deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
			<%	
				}
			%>
		</div>
